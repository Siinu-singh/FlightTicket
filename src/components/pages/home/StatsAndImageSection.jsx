        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-10">
            <div>
              <p className="text-muted-foreground leading-relaxed text-base md:text-lg">
                ...
                we provide an unparalleled travel planning experience tailored to meet your 
                needs and exceed your expectations. Your adventure starts here.
              </p>
            </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="font-semibold text-foreground">Meet Our Professional Team</h3>
                <p className="text-xs text-muted-foreground">Dedicated to your seamless travel experience.</p>
              </div>
            </div>
            ...
            <div className="space-y-8">
              {statsData.map((stat) => {
                ...
                return (
                  <div key={stat.id} className="flex items-center pb-4 border-b border-border last:border-b-0">
          ...
          <div className="relative aspect-square md:aspect-video w-full max-h-[380px] md:max-h-[420px] lg:max-h-[480px] rounded-2xl overflow-hidden shadow-2xl group">
            ...
            <Button 
              asChild 
              variant="default" 
              className="absolute top-6 right-6 z-10 bg-accent/80 hover:bg-accent text-accent-foreground backdrop-blur-sm rounded-full px-5 py-2.5 text-sm shadow-lg"
            >
