...
export function HeroSection({
  ...
  return (
    <section className={cn(
      ...
      <div className={cn(
        "relative z-20 container mx-auto px-6 sm:px-8 lg:px-12 py-24 md:py-32 drop-shadow-xl",
        textMaxWidth
      )}>
        {superTitle && (
        ...
        {showButton && (
          <Button asChild size="lg" className="bg-primary hover:bg-primary/80 text-primary-foreground shadow-xl transition-transform hover:scale-105 px-10 py-3 text-base md:text-lg rounded-lg">
