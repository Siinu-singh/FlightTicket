...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Heathrow (LHR) - London | FlightTicket`,
    description: `Find flight deals to Heathrow Airport (LHR), serving London.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Heathrow (LHR)";
  const pageGroupTitle = "London";
