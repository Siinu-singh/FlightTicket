...
export async function generateMetadata({ params }) {
  return {
    title: `Cheap Weekend Flights London | FlightTicket`,
    description: `Discover cheap weekend flight deals from London.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Cheap Weekend Flights London";
