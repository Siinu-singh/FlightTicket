...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Stansted (STN) - London | FlightTicket`,
    description: `Explore flight options to London Stansted Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Stansted (STN)";
