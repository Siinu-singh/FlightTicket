...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Gatwick (LGW) - London | FlightTicket`,
    description: `Explore flight options to London Gatwick Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Gatwick (LGW)";
