...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Paris from London | FlightTicket`,
    description: `Find flight deals for travel from London to Paris.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Paris from London";
