...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Flights to San Francisco - USA | FlightTicket`,
    description: `Find flight deals to San Francisco, CA.`,
  };
}
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="prose dark:prose-invert max-w-none mx-auto text-foreground leading-relaxed space-y-6">
        <p>This is a placeholder page for flight search results for <strong>Flights to San Francisco</strong>, as part of the <strong>United States flights</strong> category.</p>
