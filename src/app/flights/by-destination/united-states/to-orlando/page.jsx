...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Orlando (MCO) - USA | FlightTicket`,
    description: `Explore flights to Orlando International Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Orlando (MCO)";
