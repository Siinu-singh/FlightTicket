...
export async function generateMetadata({ params }) {
  return {
    title: `Flights from Tokyo to Seoul | FlightTicket`,
    description: `Explore options for flights from Tokyo to Seoul.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights from Tokyo to Seoul";
