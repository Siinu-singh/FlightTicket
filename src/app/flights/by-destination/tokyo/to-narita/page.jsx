...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Narita (NRT) - Tokyo | FlightTicket`,
    description: `Find flights to Narita International Airport (NRT), serving Tokyo.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Narita (NRT)";
  const pageGroupTitle = "Tokyo";
