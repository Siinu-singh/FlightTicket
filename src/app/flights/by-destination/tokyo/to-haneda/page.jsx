...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Haneda (HND) - Tokyo | FlightTicket`,
    description: `Explore flights to Haneda Airport (HND), serving Tokyo.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Haneda (HND)";
