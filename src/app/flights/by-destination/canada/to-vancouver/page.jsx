...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Flights to Vancouver (YVR) - Canada | FlightTicket`,
    description: `Explore flights to Vancouver International Airport.`,
  };
}
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="prose dark:prose-invert max-w-none mx-auto text-foreground leading-relaxed space-y-6">
        <p>This is a placeholder page for flight search results for <strong>Flights to Vancouver (YVR)</strong>, as part of the <strong>Canada flights</strong> category.</p>
