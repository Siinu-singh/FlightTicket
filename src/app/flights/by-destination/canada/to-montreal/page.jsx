...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Montreal (YUL) - Canada | FlightTicket`,
    description: `Find flights to Montréal-Trudeau International Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Montreal (YUL)";
