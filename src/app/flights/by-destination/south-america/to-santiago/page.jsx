...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Santiago (SCL) - South America | FlightTicket`,
    description: `Find flights to Arturo Merino Benítez Airport in Santiago.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Santiago (SCL)";
