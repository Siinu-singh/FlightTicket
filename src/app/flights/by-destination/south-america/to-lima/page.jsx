...
export async function generateMetadata({ params }) {
  ...
  return {
    title: `Flights to Lima (LIM) - South America | FlightTicket`,
    description: `Explore flights to Jorge Chávez International Airport in Lima.`,
  };
}
  ...
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
      ...
      <div className="prose dark:prose-invert max-w-none mx-auto text-foreground leading-relaxed space-y-6">
        <p>This is a placeholder page for flight search results for <strong>Flights to Lima (LIM)</strong>, as part of the <strong>South America flights</strong> category.</p>
