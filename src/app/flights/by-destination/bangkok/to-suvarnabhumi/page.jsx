...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Suvarnabhumi (BKK) - Bangkok | FlightTicket`,
    description: `Find flights to Suvarnabhumi Airport (BKK), serving Bangkok.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Suvarnabhumi (BKK)";
