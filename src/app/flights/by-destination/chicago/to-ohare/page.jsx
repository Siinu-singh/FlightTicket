...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to O'Hare (ORD) - Chicago | FlightTicket`,
    description: `Find flights to Chicago O'Hare International Airport (ORD).`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to O'Hare (ORD)";
  const pageGroupTitle = "Chicago";
