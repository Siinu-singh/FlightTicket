...
export async function generateMetadata({ params }) {
  return {
    title: `Flights from Chicago to Miami | FlightTicket`,
    description: `Explore flight options from Chicago to Miami.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights from Chicago to Miami";
