...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Ho Chi Minh City (SGN) - Southeast Asia | FlightTicket`,
    description: `Find flights to Tan Son Nhat International Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const groupTitle = "Southeast Asia";
  const linkTitle = "Flights to Ho Chi Minh City (SGN)";
