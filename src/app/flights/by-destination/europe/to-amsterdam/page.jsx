...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Amsterdam - Europe | FlightTicket`,
    description: `Find flight deals to Amsterdam, Netherlands, within Europe.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Amsterdam";
