...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Madrid (MAD) - Europe | FlightTicket`,
    description: `Explore flight options to Madrid-Barajas Adolfo Suárez Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Madrid (MAD)";
  const pageGroupTitle = "Europe";
