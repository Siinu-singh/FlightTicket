...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to LaGuardia (LGA) - New York | FlightTicket`,
    description: `Explore flight options to LaGuardia Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to LaGuardia (LGA)";
