...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to JFK Airport - New York | FlightTicket`,
    description: `Find flight deals to John F. Kennedy International Airport (JFK), serving New York.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to JFK Airport";
  const pageGroupTitle = "New York";
