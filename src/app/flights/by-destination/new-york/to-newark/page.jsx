...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Newark (EWR) - New York | FlightTicket`,
    description: `Explore flight options to Newark Liberty International Airport.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Newark (EWR)";
