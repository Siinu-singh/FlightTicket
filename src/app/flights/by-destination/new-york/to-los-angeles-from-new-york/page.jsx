...
export async function generateMetadata({ params }) {
  return {
    title: `Flights from New York to Los Angeles | FlightTicket`,
    description: `Find flight deals for travel from New York to Los Angeles.`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights from New York to Los Angeles";
