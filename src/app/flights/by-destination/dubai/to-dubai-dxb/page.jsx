...
export async function generateMetadata({ params }) {
  return {
    title: `Flights to Dubai (DXB) | FlightTicket`,
    description: `Find flight deals to Dubai International Airport (DXB).`,
  };
}

export default function FlightRoutePage({ params }) {
  const pageDisplayTitle = "Flights to Dubai (DXB)";
  const pageGroupTitle = "Dubai";
